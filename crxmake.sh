...
if test $# -lt 2; then
	...
	echo ""
	echo "crxmake.sh src extension/garmin.com.js.pem extension/garmin.com.js.crx"
	echo "crxmake.sh src extension/garmin.com.js.pem extension/garmin.com.js.crx version.txt"
	echo ""
	exit 1
else
	src=$1
